...
![設定内の Codex アプリ拡張スイッチ](/docs/assets/codex-official-auth-preservation/01-codex-app-enhancement-setting.png)
...
![Codex プロバイダー一覧内の OpenAI Official とサードパーティプロバイダー](/docs/assets/codex-deepseek-routing/01-codex-providers-require-routing.png)
...
![DeepSeek Codex プロバイダーフォーム](/docs/assets/codex-deepseek-routing/02-deepseek-codex-routing-form.png)
...
![ローカルルーティング画面で Codex ルーティングを有効化](/docs/assets/codex-deepseek-routing/03-local-route-codex-takeover.png)
...
- [Codex DeepSeek ローカルルーティング実践ガイド](/ja/tutorials/codex-deepseek-routing-guide)
- [Codex プロバイダーの追加: Chat Completions ルーティングとモデルマッピング](/ja/docs?section=providers&item=add)
- [ローカルプロキシサービス](/ja/docs?section=proxy&item=service)
- [ローカルルーティング](/ja/docs?section=proxy&item=routing)
- [CC Switch v3.16.1 Release Note](/ja/changelog/3.16.1)
