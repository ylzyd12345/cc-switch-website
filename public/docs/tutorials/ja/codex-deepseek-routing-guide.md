...
![Codex プロバイダー一覧のローカルルーティング必須マーク](/docs/assets/codex-deepseek-routing/01-codex-providers-require-routing.png)
...
![DeepSeek Codex プロバイダーフォームのローカルルーティング設定](/docs/assets/codex-deepseek-routing/02-deepseek-codex-routing-form.png)
