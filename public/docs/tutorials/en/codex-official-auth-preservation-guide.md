...
![Codex App Enhancements switch in Settings](/docs/assets/codex-official-auth-preservation/01-codex-app-enhancement-setting.png)
...
![OpenAI Official and third-party providers in the Codex provider list](/docs/assets/codex-deepseek-routing/01-codex-providers-require-routing.png)
...
![DeepSeek Codex provider form](/docs/assets/codex-deepseek-routing/02-deepseek-codex-routing-form.png)
...
![Enabling Codex takeover on the local routing page](/docs/assets/codex-deepseek-routing/03-local-route-codex-takeover.png)
...
- [Local Routing](/en/docs?section=proxy&item=routing)
- [CC Switch v3.16.1 Release Note](/en/changelog/3.16.1)
