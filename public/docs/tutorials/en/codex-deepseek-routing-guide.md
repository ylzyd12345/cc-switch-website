...
![Needs routing marker in the Codex provider list](/docs/assets/codex-deepseek-routing/01-codex-providers-require-routing.png)
...
![Local routing mapping in the DeepSeek Codex provider form](/docs/assets/codex-deepseek-routing/02-deepseek-codex-routing-form.png)
...
![Enabling Codex routing on the local routing page](/docs/assets/codex-deepseek-routing/03-local-route-codex-takeover.png)
