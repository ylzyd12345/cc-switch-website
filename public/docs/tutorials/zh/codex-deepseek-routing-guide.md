...
![Codex 供应商列表里的需要路由标记](/docs/assets/codex-deepseek-routing/01-codex-providers-require-routing.png)
...
![DeepSeek Codex 供应商表单中的本地路由映射](/docs/assets/codex-deepseek-routing/02-deepseek-codex-routing-form.png)
