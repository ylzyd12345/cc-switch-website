...
![设置里的 Codex 应用增强开关](/docs/assets/codex-official-auth-preservation/01-codex-app-enhancement-setting.png)
...
![Codex 供应商列表中的 OpenAI Official 与第三方供应商](/docs/assets/codex-deepseek-routing/01-codex-providers-require-routing.png)
...
![DeepSeek Codex 供应商表单](/docs/assets/codex-deepseek-routing/02-deepseek-codex-routing-form.png)
...
![本地路由页面中启用 Codex 接管](/docs/assets/codex-deepseek-routing/03-local-route-codex-takeover.png)
...
- [本地路由](/zh/docs?section=proxy&item=routing)
- [CC Switch v3.16.1 Release Note](/zh/changelog/3.16.1)
